      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="flex-1 bg-brand-600 text-white py-3 px-6 rounded-md font-medium hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed shadow-card-md"
          >
            {isSubmitting ? (
